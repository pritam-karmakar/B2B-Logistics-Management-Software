            ...
            <div class="col-12 col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title"><strong>Calculator for Freight</strong></h3>
                    </div>
                    <div class="card-body" id="freight-master">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                    	            <select class="form-control" name="user-type">
                    	                ...
                    	                <option value="users" <?php if($visible == "users"){ echo 'selected'; } ?>>Users</option>
                    	                <option value="branches" <?php if($visible == "branches"){ echo 'selected'; } ?>>Branches</option>
                    	            </select>
                                </div>
                                <span class="text-danger user-type-error d-flex justify-content-end" style="font-size: 12px;"></span>
                            </div>
                            <div class="col-md-6">
                                <label>Choose one <span class="text-danger">*</span></label>
                                <div class="input-group">
                    	            <select class="form-control form-control-sm" id="single-select" name="UsersorBranches">
                    	                <option value="" hidden>Choose one</option>
                    	            </select>
                                </div>
                                <span class="text-danger UsersorBranches-error d-flex justify-content-end" style="font-size: 12px;"></span>
                            </div>
                            <div class="col-md-6 pt-3">
                                <label>Origin Pincode <span class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text" id="basic-addon11"><i class="bi bi-geo-alt-fill"></i></span>
                            ...
                            <div class="col-md-4 pt-3">     
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text" id="totalWeight"><i class="bi bi-archive-fill"></i></span>
                            ...
                            <div class="col-md-4 pt-3">     
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text" id="totalBoxes"><i class="bi bi-box-seam-fill"></i></span>
                            ...
                            <div class="col-md-4 pt-3">     
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text" id="basic-addon11"><i class="bi bi-box-fill"></i></span>
                            ...
                            <div class="col-md-4 pt-3">     
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text" id="basic-addon11"><i class="bi bi-currency-rupee"></i></span>
                            ...
                            <div class="row" id="row0">
                                ...
                                <div class="col-lg-1 d-flex justify-content-end align-items-center" style="padding-top: 1.5rem;">  
                                    <div class="text-center">
                                        <button id="add_weight" type="button" class="btn btn-info btn-sm"><i style="font-size: 17px;" class="bi bi-plus-circle-fill"></i></button>
                                    </div> 
                                </div>
                            </div>
                        </div>
...
?>
<script src="assets/freight.js"></script>