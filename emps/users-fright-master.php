		...
		<div class="row">
		    <div class="card">
		        <div class="card-header">
		            <h3 class="card-title">User's Fright Master</h3>
		        </div>
		        <div class="card-body">
		             <div class="table-responsive">
                    	<table id="example3" class="display" style="width:100%">
                    		...
                    		<tbody>
                    		    <?php
                    		        $users = $query->getData('*','users','',array('fright_charge'=>'yes','delete_status'=>'show'),'id','DESC','');
                    		        foreach($users as $getusers){
                    		    ?>
                    			<tr>
                    				<td><?= $getusers['party_name']; ?></td>
                    				<td><?= $getusers['username']; ?></td>
                    				<td><?= $getusers['contact_person']; ?></td>
                    				<td><?= $getusers['phone_no']; ?></td>
                    				<td><?= $getusers['email']; ?></td>
                    				<td><?= $getusers['address']; ?></td>
                    				<td>
                    				    <div class="d-flex">
										    <a type="button" data-bs-toggle="modal" data-bs-target=".bd-example-modal-lg<?= $getusers['username']; ?>" class="btn btn-warning shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
										    <a type="button" data-bs-toggle="modal" data-bs-target=".bd-example-modal-lg-percent<?= $getusers['username']; ?>" style="color: #fff; background-color: #ffba00;" class="btn shadow btn-xs sharp me-1"><i class="fas fa-percentage"></i></a>
										</div>
                    				</td>
                    			</tr>
                    			
                    			<div class="modal fade bd-example-modal-lg-percent<?= $getusers['username']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <form action="actions" method="POST" onsubmit="return confirm('Are you sure to want to update this user\'s freight?')">
                                            <input type="hidden" value="<?= $getusers['username']; ?>" name="UserName">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Edit default fright master by percentage for <?= $getusers['party_name']; ?> (<?= $getusers['username'];  ?>)</h5>
                                                    ...
                                                    <div class="row d-flex justify-content-center">
                                                        <div class="col-md-8">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="text" class="form-control form-control-sm numeric-decimal" placeholder="Enter Percentage"  name="percent" required>
                                                ...
                                                <div class="modal-footer d-flex p-2" style="justify-content: space-between;">
                                                    <button class="btn btn-danger btn-sm" type="reset">Reset <i class="bi bi-slash-circle"></i></button>
                                                    <button class="btn btn-warning btn-sm" type="submit" name="savethisUsersFreight">Save Changes <i class="bi bi-pen-fill"></i></button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                    			...
                    			<div class="modal fade bd-example-modal-lg<?= $getusers['username']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog modal-xl">
                                        <?php
                            		        $frights = $query->getData('*','users_fright_master','',array("user_id"=>$getusers['id']),'id','DESC','1')[0];
                            		    ?>
                        		        <div class="card-normal">
                                            <form action="actions" method="POST">
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">Edit default fright master for <?= $getusers['party_name']; ?> (<?= $getusers['username'];  ?>)</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <div class="row">
                                    		        ...
                                    		        <div class="modal-footer d-flex" style="justify-content: space-between;">
                                    		            ...
                                    		            <button class="btn btn-warning btn-sm" type="submit" name="saveChangesUsersFrightMaster">Save Changes <i class="bi bi-pen-fill"></i></button>
                                    		        </div>
                                                </div>
                                            </form>
                        		        </div>
                                  ...
                                  <!--              <div class="modal-content">-->
                                  <!--                  <div class="modal-header">-->
                                  <!--                      <h5 class="modal-title">Edit default fright master for <?= $getusers['branch_name']; ?> (<?= $getusers['branch_user_name'];  ?>)</h5>-->
                                  <!--                      <button type="button" class="btn-close" data-bs-dismiss="modal"></button>-->
                                  <!--                  </div>-->
                                  <!--                  <div class="modal-body">-->
                                  <!--                      <div class="row">-->
