...
$query = new query();
if(isset($_SESSION['ltl_emp_id']) && !empty($_SESSION['ltl_emp_id']) && isset($_SESSION['ltl_emp_code']) && !empty($_SESSION['ltl_emp_code'])){
    $ltl_emp_id = $_SESSION['ltl_emp_id'];
    $getdetails = $query->getData("*","employees","",array("id"=>$ltl_emp_id),"id","DESC","1");
    $getRoleItems = $query->getData("*","roles","",array("id"=>$getdetails[0]['designation'],"delete_status"=>"show"),"id","DESC","1")[0];
    $getroles = explode(",", $getRoleItems['roles']);
}else{
...
<head>
    <!--Title-->
	<title><?= $pagename; ?> - Employee || Kingfish Logistics</title>
											...
											<div class="card border-0 mb-0">
												<div class="card-header py-2">
													<div class="products">
														...
														<div>
															<h6><?= $getdetails[0]['employee_name']; ?></h6>
															<span><?= $getdetails[0]['employee_code']; ?></span>	
														</div>	
													</div>
												</div>
