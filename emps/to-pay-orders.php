		...
		<div class="row">
		    <div class="card">
		        <div class="card-header">
		            <h3 class="card-title"><?php if(!empty($orderUsersorBranches)){ echo $orderUsersorBranches."<span style='text-transform: lowercase;'>'s</span>"; }else{ if($visible == "users" || $visible == "branches"){ echo 'All '.ucwords(rtrim(rtrim($visible, "s"), "es"))."<span style='text-transform: lowercase;'>'s</span>"; } } ?> To-Pay Orders</h3>
		        </div>
		        <div class="card-body">
                    	...
                    	<table id="example5" class="display table" style="min-width: 845px">
                    		...
                    		<tbody>
                                <?php
                                  ...
                                  $showusercond = array("payment_mode"=>"To-Pay");
