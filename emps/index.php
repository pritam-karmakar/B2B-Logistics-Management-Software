<?php
    ...
    if(isset($_POST['signin'])){
        ...
        $getlogin = $newquery->getData("*","employees","",array("employee_code"=>$username,"delete_status"=>"show"),"","","");
        if($getlogin != 0){
            if($getlogin[0]['status'] == "Unblock"){
                if($getlogin[0]['password'] == $userpassword){
                    $_SESSION['ltl_emp_id'] = $getlogin[0]['id'];
                    $_SESSION['ltl_emp_code'] = $getlogin[0]['employee_code'];
                ...
                echo '<script type="text/javascript" language="javascript">
                        alert("You have been blocked to access you account!");
                        window.location = "index";
                      </script>';
            }
        }else{
...
<head>
   <!--Title-->
	<title>LTL Employee || Kingfisher Logistics</title>
                ...
                <div class="col-md-12">
                    <div class="authincation-content">
                        <div class="row no-gutters" style="display: flex; justify-content: center; align-items: center;">
                            <div class="col-xl-6">
                                <img src="https://img.freepik.com/free-vector/my-password-concept-illustration_114360-3864.jpg" style="width: 100%;">
                            </div>
                            <div class="col-xl-6">
                                <div class="auth-form">
                                    ...
                                    <form action="index" method="POST">
                                        ...
                                        <div class="text-center">
                                            <button type="submit" class="btn btn-block" style="background-color: #00363a !important; border: none; color: #fff;" name="signin">Sign In</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
