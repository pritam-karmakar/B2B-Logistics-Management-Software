		...
		<div class="row">
		    <div class="card">
		        <div class="card-header">
		            <h3 class="card-title">Invoice Stationaries</h3>
		        </div>
		        <div class="card-body">
    		            ...
    		            <div class="row">
    		                <div class="col-md-4">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control form-control-sm" name="stationary_name" placeholder="Enter Name" required>
                                </div>
    		                </div>
    		                <div class="col-md-4">
                                <label>Prefix</label>
                                <div class="input-group mb-3">
									...
									<button class="btn btn-primary btn-sm" type="submit" name="submitStationary">Submit</button>
                                </div>
    		                </div>
    		            </div>
                    </form>
                    	...
                    	<table id="example3" class="display" style="width:100%">
                    		...
                    		<tbody>
                    		    <?php
                                    ...
                                    $getstationaries = $query->getData("*","stationaries","",$whr,"","","");
                        				...
                        				<td>
                        				    <div class="d-flex">
    											...
    											<form action="actions" method="POST">
    											    ...
    											    <button type="submit" class="btn btn-danger shadow btn-xs sharp" name="deleteStationary" onclick="return confirm('Are you sure to want to delete this item?')"><i class="fa fa-trash"></i></button>
    											</form>
    										</div>
                        				</td>
                        			</tr>
                                            ...
                                            <div class="modal-content">
                                                <form action="actions" method="POST">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit" name="editStationary" class="btn btn-warning btn-sm">Save changes</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
