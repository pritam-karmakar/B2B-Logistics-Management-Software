		...
		<div class="row">
		    <div class="card">
		        <div class="card-header">
		            <h3 class="card-title">Branch's Fright Master</h3>
		        </div>
		        <div class="card-body">
		             <div class="table-responsive">
                    	<table id="example3" class="display" style="width:100%">
                    		...
                    		<tbody>
                    		    <?php
                    		        $condArr = array('branch_charge'=>'yes','delete_status'=>'show');
                    			...
                    			<tr>
                    				...
                    				<td>
                    				    <div class="d-flex">
										    <a type="button" data-bs-toggle="modal" data-bs-target=".bd-example-modal-lg<?= $getbranches['branch_user_name']; ?>" class="btn btn-warning shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
										    <a type="button" data-bs-toggle="modal" data-bs-target=".bd-example-modal-lg-percent<?= $getbranches['branch_user_name']; ?>" style="color: #fff; background-color: #ffba00;" class="btn shadow btn-xs sharp me-1"><i class="fas fa-percentage"></i></a>
										</div>
                    				</td>
                    			</tr>
                    			
                    			<div class="modal fade bd-example-modal-lg-percent<?= $getbranches['branch_user_name']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <form action="actions" method="POST" onsubmit="return confirm('Are you sure to want to update this branch\'s freight?')">
                                            <input type="hidden" value="<?= $getbranches['branch_user_name']; ?>" name="BranchUserName">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Edit default fright master by percentage for Branch:<br/><?= $getbranches['branch_name']; ?> (<?= $getbranches['branch_user_name'];  ?>)</h5>
                                                ...
                                                <div class="modal-footer d-flex p-2" style="justify-content: space-between;">
                                                    ...
                                                    <button class="btn btn-warning btn-sm" type="submit" name="savethisBranchesFreight">Save Changes <i class="bi bi-pen-fill"></i></button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                    			...
                    			<div class="modal fade bd-example-modal-lg<?= $getbranches['branch_user_name']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
