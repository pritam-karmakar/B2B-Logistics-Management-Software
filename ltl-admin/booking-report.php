...
<div class="content-body">
	<div class="container-fluid">
	    <form action="booking-report" method="GET" class="row mb-3">
	        <div class="col-xl-4 col-sm-6 form-group">
	            <label>Choose user</label>
	            <select class="form-control" id="single-select" name="orderUsersorBranches">
		...
		<div class="row">
		    <div class="card">
		        <div class="card-header">
		            <h3 class="card-title"><?php if(!empty($orderUsersorBranches)){ echo $orderUsersorBranches."<span style='text-transform: lowercase;'>'s</span>"; }else{ echo 'All Users'; } ?> Booking Orders</h3>
                    	...
                    	<table id="example5" class="display table" style="min-width: 845px">
                    		<thead>
                    			<tr>
                                    ...
                                    <th class="text-center">Party Name (username)</th>
                                    ...
                                    <th class="text-center">Voluematric Weight</th>
                                    ...
                                    <th class="text-center">ODA Charge</th>
                                    ...
                                    <th class="text-center">Client GSTIN</th>
                                    <th class="text-center">Delhivery GSTIN</th>
                    		...
                    		<tbody>
                                <?php
                                    ...
                                    $showusercond = array("user_type"=>"users");
                                    if(!empty($orderUsersorBranches)){
                                        $showusercond['type_id'] = $query->getData('`id`','users','',array('username'=>$orderUsersorBranches),'id','DESC','1')[0]['id'];
                                    }
                                    ...
                                    if(!empty($startDate) && !empty($endDate)){
                                        unset($showusercond);
                                        $showusercond = array(array("user_type","=","users"));
                                        if(!empty($orderUsersorBranches)){
                                            $showusercond[] = array("type_id","=",$query->getData('`id`','users','',array('username'=>$orderUsersorBranches),'id','DESC','1')[0]['id']);
                                        }
                                    ...
                                    foreach($order_details as $orders){
                                        $getUser = $query->getData('*','users','',array('id'=>$orders['type_id']),'','','')[0];
                                        ...
                                        $invs = $query->getData('*','invoice_details','',array('order_id'=>$order['order_id']),'id','DESC','');
                                        $inv_numbers;
                                        $ewaybills;
                                        if($invs != 0){
                                            foreach($invs as $inv){
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-center"><?= $getUser['party_name']."- (".$getUser['username'].")"; ?></td>
                                        <td class="text-center"><?= $getUser['party_name']."- (".$getUser['username'].")"; ?></td>
                                        ...
                                        <td class="text-center"><?php if(empty($orders['cartage_charge'])){ echo 0; }else{ echo $orders['cartage_charge']; } ?></td>
