...
if(isset($_SESSION['ltl_admin_id']) && !empty($_SESSION['ltl_admin_id']) && isset($_SESSION['ltl_admin_username']) && !empty($_SESSION['ltl_admin_username'])){
    ...
    $getdetails = $query->getData("*","admin_login","","","","","");
}else{
    header("location:index");
}
$thisPage = explode("/", $_SERVER['PHP_SELF']);
$pagename = str_replace("Tds", "TDS", str_replace("Lr", "LR", ucwords(str_replace("-", " ", str_replace(".php", "", end($thisPage))))));
define("CurrentPageURL", str_replace(".php", "", end($thisPage)));
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <!--Title-->
	<title><?= $pagename; ?> - ltl-admin || Kingfish Logistics</title>
	...
	<!-- FAVICONS ICON -->
	<link rel="shortcut icon" type="image/png" href="https://kingfishlogistics.in/images/logo/logo.png">
	
	<link href="vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
	<link href="vendor/swiper/css/swiper-bundle.min.css" rel="stylesheet">
	<link rel="stylesheet" href="ajax/libs/noUiSlider/14.6.4/nouislider.min.css">
	<link href="vendor/datatables/css/jquery.dataTables.min.css" rel="stylesheet">
	<link href="buttons/1.6.4/css/buttons.dataTables.min.css" rel="stylesheet">
    ...
    <link href="assets/newStyle.css" rel="stylesheet">
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="dashboard" class="brand-logo p-0" style="flex-direction: column;">
                <img src="https://kingfishlogistics.in/images/logo/logo.png" style="height: 100%; width: 100%;">
            </a>
										...
										<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
											<div class="header-info2 d-flex align-items-center">
												<div class="header-media">
													<img src="images/new-default-user.png" style="height: 40px;" alt="">
												</div>
											</div>
										</a>
										<div class="dropdown-menu dropdown-menu-end" style="">
											<div class="card border-0 mb-0">
												<div class="card-header py-2">
													<div class="products">
														<img src="images/new-default-user.png" style="height: 40px;" class="avatar avatar-md" alt="">
														<div>
															<h6><?= $getdetails[0]['name']; ?></h6>
															<span><?= $getdetails[0]['username']; ?></span>	
														</div>	
													</div>
												</div>
												<div class="card-body px-0 py-2">
													...
													<a href="track-lr" class="dropdown-item ai-icon ">
														<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo-alt-fill" viewBox="0 0 16 16">
                                                          <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10m0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6"/>
                                                        </svg>
														<span class="ms-2">Track by LRN</span>
													</a>
													<a href="pincode-serviceability" class="dropdown-item ai-icon ">
														...
														<span class="ms-2">PIN Code Serviceability</span>
													</a>
													<a href="freight-estimator" class="dropdown-item ai-icon ">
														...
														<span class="ms-2">Freight Estimator</span>
													</a>
												</div>
