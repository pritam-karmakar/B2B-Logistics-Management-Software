				...
				<ul class="metismenu" id="menu">
					...
					<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
						...
						<ul aria-expanded="false">
							...
							<li>
							    <a href="edit-lr">Edit LR</a>
						    </li>
							<li>
							    <a href="bulk-update-lr-weight">Bulk update LR weight</a>
						    </li>
						</ul>
					</li>
					<li class="menu-title"><span>USER CONTROL</span></li>
					...
					<li><a href="booking-report" aria-expanded="false">
						<div class="menu-icon">
					...
					<li><a href="outstanding-report" aria-expanded="false">
						<div class="menu-icon">
					...
					<li><a href="branch-report" aria-expanded="false">
						<div class="menu-icon">
					...
					<li><a href="broker-report" aria-expanded="false">
						<div class="menu-icon">
					...
					<li class="menu-title"><span>COMPANY MASTER</span></li>
					...
					<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
						...
						<ul aria-expanded="false">
							...
							<!--<li>-->
							<!--    <a href="zone-master-cities" aria-expanded="false">Cities</a>-->
							<!--</li>-->
							<li>
					...
					<li class="menu-title"><span>OTHER FEATURES</span></li>
					<li>
					...
					<li>
					    <a href="support-ticket?tickets=Open" aria-expanded="false">
						<div class="menu-icon">
