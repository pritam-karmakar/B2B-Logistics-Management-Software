            ...
            <div class="row">
                <div class="col-12 col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="act" method="POST" class="row" onsubmit="return confirm('Are you sure to want to create pickup request')">
                                <?php
                                ...
                                <div class="text-end">
                                    <button type="submit" name="createPickupRequest" class="btn btn-label-primary">Create</button>
                                </div>
                            </form>
                        </div>
                    </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            $pickup_request = $query->getData("*","pickup_request","",array("type"=>"users","type_id"=>$user_id),"id","DESC",$limit);
                                            $pickupRequestCount = $query->getData("COUNT(`id`) as 'pickupRequestCount'","pickup_request","",array("type"=>"users","type_id"=>$user_id),"id","DESC","")[0]['pickupRequestCount'];
