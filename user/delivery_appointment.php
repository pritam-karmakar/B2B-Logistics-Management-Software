                                  ...
                                  <div class="modal-content">
                                    ...
                                    <form action="action" method="POST">
                                        <div class="modal-body">
                                            <div class="row mb-3">
                                                <div class="col-12">
                                                    <label for="select2Basic" class="form-label">LR No.*</label>
                                                    <select class="select2 form-select form-select-lg"  id="select2Basic" name="lr_no" required>
                                                        <option value="" hidden>Choose LR</option>
                                                        <?php
                                                            $appoint = $query->getData("*","orders","",array("user_type"=>"users","type_id"=>$user_id),"order_id","DESC","");
                                                            foreach($appoint as $lrs){
                                                        ?>
                                                            <option value="<?= $lrs['lr']; ?>"><?= $lrs['lr']; ?></option>
                                                        <?php
                                                            }
                                                        ?>
                                                    </select>
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-12">
                                                    ...
                                                    <input type="date" id="appointment_date" name="appointment_date" class="form-control" placeholder="Select Your Preferred Date" required>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <div class="col-6">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-12">
                                                    ...
                                                    <input type="text" id="appointment_id" name="appointment_id" class="form-control" placeholder="Enter Your Appointment ID" required>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <div class="col-12">
                                                    <label for="po" class="form-label">PO#</label>
                                                    <input type="text" id="po" name="po" class="form-control" placeholder="Enter PO#" required>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="card-body">
                    <div class="table-responsive text-nowrap">
                        <table class="table">
                            ...
                            <tbody>
                                <?php
                                    $appointments = $query->getData("`appointments`.*,`orders`.`lr`","appointments",array(array("LEFT","orders","orders","lr","appointments","lr_no")),array("appointments`.`user_type"=>"users","appointments`.`type_id"=>$user_id),"appointments`.`id","DESC","");
                                    if($appointments != 0){
