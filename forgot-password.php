...
if(isset($_POST['sendOTP']) && !empty($_POST['email'])){
    ...
    $getEmaildetails = $newquery->getData("*","users","",array("email"=>$email),"id","DESC","");
    if($getEmaildetails != 0):
        if($email == $getEmaildetails[0]['email']):
            $otp = rand(100000,999999);
            $updOtp = $newquery->updateData("users",array("verification_otp"=>$otp),"id",$getEmaildetails[0]['id']);
            if($updOtp):
                $headers = [
                    "MIME-Version" => "1.0",
                ...
                if(mail($to, $subject, $message, $headers)):
                    $_SESSION['sent_otp_email_type'] = "users";
            ...
            <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-sm-5 p-4">
                <div class="w-px-400 mx-auto">
                    ...
                    <div class="text-center">
                        <a href="https://b2b.kingfishlogistics.in/" class="d-flex align-items-center justify-content-center">
