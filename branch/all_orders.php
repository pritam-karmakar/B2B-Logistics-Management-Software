...
include('menu/navbar.php');
    ...
    if(isset($_GET['lr']) && isset($_GET['payment_mode']))
    {
        ...
        {
            $order_cond = array(array("user_type","=","branches"),array("type_id","=",$user_id),array("lr","=",$lr),array("payment_mode","=",$payment_mode),array("status","=","Complete","OR","status","=","MANIFESTED"),array("user_type","=","branches"),array("type_id","=",$user_id),array("lr","=",$lr),array("payment_mode","=",$payment_mode));
            $intrans_cond = array(array("user_type","=","branches"),array("type_id","=",$user_id),array("lr","=",$lr),array("payment_mode","=",$payment_mode),array("status","!=","Complete"),array("status","!=","MANIFESTED"),array("status","!=","DELIVERED"));
            $intrans_cond = array(array("user_type","=","branches"),array("type_id","=",$user_id),array("lr","=",$lr),array("payment_mode","=",$payment_mode),array("status","=","DELIVERED"));
        }
        elseif(empty($lr)&& !empty($payment_mode))
        {
            $order_cond = array(array("user_type","=","branches"),array("type_id","=",$user_id),array("payment_mode","=",$payment_mode),array("status","=","Complete","OR","status","=","MANIFESTED"),array("user_type","=","branches"),array("type_id","=",$user_id),array("payment_mode","=",$payment_mode));
            $intrans_cond = array(array("user_type","=","branches"),array("type_id","=",$user_id),array("payment_mode","=",$payment_mode),array("status","!=","Complete"),array("status","!=","MANIFESTED"),array("status","!=","DELIVERED"));
            $intrans_cond = array(array("user_type","=","branches"),array("type_id","=",$user_id),array("payment_mode","=",$payment_mode),array("status","=","DELIVERED"));
        }
        elseif(!empty($lr) && empty($payment_mode))
        {
            $order_cond = array(array("user_type","=","branches"),array("type_id","=",$user_id),array("lr","=",$lr),array("status","=","Complete","OR","status","=","MANIFESTED"),array("user_type","=","branches"),array("type_id","=",$user_id),array("lr","=",$lr));
            $intrans_cond = array(array("user_type","=","branches"),array("type_id","=",$user_id),array("lr","=",$lr),array("status","!=","Complete"),array("status","!=","MANIFESTED"),array("status","!=","DELIVERED"));
            $delveri_cond = array(array("user_type","=","branches"),array("type_id","=",$user_id),array("lr","=",$lr),array("status","=","DELIVERED"));
        }
        else
        {
            $order_cond = array(array("user_type","=","branches"),array("type_id","=",$user_id),array("status","=","Complete","OR","status","=","MANIFESTED"),array("user_type","=","branches"),array("type_id","=",$user_id));
            $intrans_cond = array(array("user_type","=","branches"),array("type_id","=",$user_id),array("status","!=","Complete"),array("status","!=","MANIFESTED"),array("status","!=","DELIVERED"));
            $delveri_cond = array(array("user_type","=","branches"),array("type_id","=",$user_id),array("status","=","DELIVERED"));
        }
    }
    else
    {
        $order_cond = array(array("user_type","=","branches"),array("type_id","=",$user_id),array("status","=","Complete","OR","status","=","MANIFESTED","AND","user_type","=","branches","AND","type_id","=",$user_id,"OR","status","=","Created"),array("user_type","=","branches"),array("type_id","=",$user_id));
        $intrans_cond = array(array("user_type","=","branches"),array("type_id","=",$user_id),array("status","!=","Complete"),array("status","!=","MANIFESTED"),array("status","!=","DELIVERED"),array("status","!=","Created"));
        $delveri_cond = array(array("user_type","=","branches"),array("type_id","=",$user_id),array("status","=","DELIVERED"));
    }
    const dataShow = 25;
    if(empty($page)){
