                ...
                <div class="card-header">
                    <div class="row mb-3">
                        <div class="col-12 d-flex justify-content-end">
                            <a href="add_cashbook" class="btn btn-info">Create New Request</a>
                    ...
                    <div class="table-responsive text-nowrap">
                        <table class="table">
                            ...
                            <tbody>
                                <?php
                                    $sl = 1;
                                    $where = array("branch_id"=>$user_id);
                                    $cashbook = $query->getData("*","cashbook","",$where,"id","DESC","");
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?= date("d-m-Y h:i A", strtotime($val['updated_at'])); ?></td>
                                    <td class="text-center"><?= date("d-m-Y h:i A", strtotime($val['created_at'])); ?></td>
                                </tr>
                                <?php
                                    }
                                ?>
