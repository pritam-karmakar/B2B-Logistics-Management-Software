...
$query = new query();
    ...
    {
        $ticket_code='TICKET'.rand(1111,9999);
        extract($_POST);
        $remarks = str_replace("'", "\'", $remarks);
        $table='tickets';
        date_default_timezone_set('Asia/Calcutta'); 
        $create_date = date('d-m-Y H:i:s');
        $condition = array("ticket_code"=>$ticket_code,"type"=>'branches',"type_id"=>$user_id,"email"=>$email,"ticket_category"=>$ticket_category,"ticket_sub_category"=>$ticket_sub_category,"remarks"=>$remarks,"created_on"=>$create_date,"last_update"=>$create_date);
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 mb-3">
                                                        ...
                                                        <input type="hidden" value="branches" id="type">
                                                    </div>
                                                </div>
                                            </div>
