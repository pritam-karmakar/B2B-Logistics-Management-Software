...
?>
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            ?>
            <h4 class="fw-bold py-3 mb-4"><span class="text-dark fw-bold">Create New Order</span></h4>
                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div id="part-1">
                            ...
                            <input type="hidden" id="branch_type" value="<?= $get_user_details[0]['type']; ?>">
                            <?php
                            if($get_user_details[0]['type']=='agent') 
                            {
                                ?>
                                ...
                                <input type="hidden" id="cartage_charge" name="applied_cartage_charge"  value="<?= $get_user_details[0]['cartage_charge']; ?>">
                                <input type="hidden" id="cartage_charge_type"  name="applied_cartage_charge_type" value="<?= $get_user_details[0]['cartage_charge_type']; ?>">
                            ...
                            else
                            {
                                ?>
                                <div class="card mt-3">
                                	<div class="card-header"> <strong class="card-title">Charges Details</strong></div>
                                	<div class="card-body" >
                                	    <div class="row">
                                	        <div class="col-md-6 row">
                                        		<div class="col-md-4">
                                        			<label>COD Min.</label>
                                        			<input type="text" class="form-control numeric-decimal" placeholder="COD Min." id="cod_charge_min" name="applied_cod_charge_min">
                                        			<span class="text-danger" id="cod_charge_min_error"></span>
                                        		</div>
                                        		<div class="col-md-8">
                                        			<label>COD Charge</label>
                                        			<div class="input-group">
                                        				<input type="text" class="form-control " placeholder="COD Charge" id="cod_charge" name="applied_cod_charge">
                                        				<select class="form-control"  id="cod_charge_type" name="applied_cod_charge_type">
                                        					<option>Fixed</option>
                                        					<option>Percentage</option>
                                        				</select>
                                        			</div>
                                        			<span class="text-danger" id="cod_charge_error"></span>
                                        		</div>
                                        		<div class="col-md-8">
                                        			<label>Fuel Surcharge</label>
                                        			<div class="input-group">
                                        				<input type="text" class="form-control numeric-decimal" id="fuel_surcharge" placeholder="Fuel Surcharge" name="applied_fuel_surcharge">
                                        				<select class="form-control" id="fuel_surcharge_type" name="applied_fuel_surcharge_type">
                                        					<option>Fixed</option>
                                        					<option>Percentage</option>
                                        				</select>
                                        			</div>
                                        			<span class="text-danger" id="fuel_surcharge_error"></span>
                                        		</div>
                                        		<div class="col-md-4">
                                        			<label>AWB Charge</label>
                                        			<div class="input-group">
                                        				<input type="text" class="form-control numeric-decimal" placeholder="AWB Charge" id="awb_charge" name="applied_awb_charge">
                                        			</div>
                                        			<span class="text-danger" id="awb_charge_error"></span>
                                        		</div>
                                        		<div class="col-md-6">
                                        			<label>FOV Surcharge</label>
                                        			<div class="input-group">
                                        				<input type="text" class="form-control numeric-decimal" placeholder="FOV Min" id="fob_surcharge_minimum"  name="applied_fob_surcharge_minimum">
                                        				<input type="text" class="form-control numeric-decimal" placeholder="FOV in %" id="fob_surcharge_percentage" name="applied_fob_surcharge_percentage">
                                        			</div>
                                        			<span class="text-danger" id="fob_surcharge_minimum_error"></span><span class="text-danger" id="fob_surcharge_percentage_error"></span>
                                        		</div>
                                        		<div class="col-md-6">
                                        			<label>Handeling Charge</label>
                                        			<div class="input-group">
                                        				<input type="text" class="form-control numeric-decimal" placeholder="Handeling Charge" id="handeling_charge"  name="applied_handeling_charge">
                                        				<select class="form-control" id="handeling_charge_type" name="applied_handeling_charge_type">
                                        					<option>Kg</option>
                                        					<option>Quantity</option>
                                        				</select>
                                        			</div>
                                        			<span class="text-danger" id="handeling_charge_error"></span>
                                        		</div>
                                        		<div class="col-md-12">
                                        			<label>Pickup Charge</label>
                                        			<div class="input-group">
                                        				<input type="text" class="form-control numeric-decimal" placeholder="Pickup Charge" id="pickup_charge" name="applied_pickup_charge">
                                        				<select class="form-control" id="pickup_charge_type" name="applied_pickup_charge_type">
                                        					<option>Kg</option>
                                        					<option>Quantity</option>
                                        				</select>
                                        			</div>
                                        			<span class="text-danger" id="pickup_charge_error"></span>
                                        		</div>
                                        	</div>
                                	        <div class="col-md-6 row">
                                        		<div class="col-md-4 mb-4">
                                        			<label>Damrage Min.</label>
                                        			<input type="text" class="form-control numeric-decimal" placeholder="Damrage Min." id="damage_surcharge_min" name="applied_damage_surcharge_min">
                                        			<span class="text-danger" id="damage_surcharge_min_error"></span>
                                        		</div>
                                        		<div class="col-md-8 mb-4">
                                        			<label>Damrage Surcharge</label>
                                        			<div class="input-group">
                                        				<input type="text" class="form-control numeric-decimal" placeholder="Damrage Surcharge" id="damage_surcharge" name="applied_damage_surcharge">
                                        				<select class="form-control" id="damage_surcharge_type" name="applied_damage_surcharge_type">
                                        					<option>Kg</option>
                                        					<option>Quantity</option>
                                        				</select>
                                        			</div>
                                        			<span class="text-danger" id="damage_surcharge_error"></span>
                                        		</div>
                                        		<div class="col-md-4 mb-4">
                                        			<label>ODA Min.</label>
                                        			<input type="text" class="form-control numeric-decimal"  placeholder="ODA Min." id="oda_surcharge_min" name="applied_oda_surcharge_min">
                                        			<span class="text-danger" id="oda_surcharge_min_error"></span>
                                        		</div>
                                        		<div class="col-md-8 mb-4">
                                        			<label>ODA Surcharge</label>
                                        			<div class="input-group">
                                        				<input type="text" class="form-control numeric-decimal" placeholder="ODA Surcharge" id="oda_surcharge" name="applied_oda_surcharge">
                                        				<select class="form-control" id="oda_surcharge_type"  name="applied_oda_surcharge_type">
                                        					<option>Kg</option>
                                        					<option>Quantity</option>
                                        				</select>
                                        			</div>
                                        			<span class="text-danger" id="oda_surcharge_error"></span>
                                        		</div>
                                        		<div class="col-md-6 mb-4">
                                        			<label>Packaging Surcharge</label>
                                        			<div class="input-group">
                                        				<input type="text" class="form-control numeric-decimal" placeholder="Packaging Surcharge" id="packaging_surcharge" name="applied_packaging_surcharge">
                                        				<select class="form-control" id="packaging_surcharge_type"  name="applied_packaging_surcharge_type">
                                        					<option>Kg</option>
                                        					<option>Quantity</option>
                                        				</select>
                                        			</div>
                                        			<span class="text-danger" id="packaging_surcharge_error"></span>
                                        		</div>
                                        		<div class="col-md-6 mb-4">
                                        			<label>Cartage Surcharge</label>
                                        			<div class="input-group">
                                        				<input type="text" class="form-control numeric-decimal" placeholder="Cartage Surcharge" id="cartage_charge" name="applied_cartage_charge" >
                                        				<input type="hidden" id=""  name="applied_cartage_charge_type" value="not_applied">
                                        			</div>
                                        			<span class="text-danger" id="cartage_charge_error"></span>
                                        		</div>
                                        		<div class="col-md-5 mb-4">
                                        			<label>Spec Del / App Min.</label>
                                        			<input type="text" class="form-control numeric-decimal" id="special_delivery_or_appointment_charge_min" placeholder="Special Delivery / App Min." name="applied_special_delivery_or_appointment_charge_min">
                                        			<span class="text-danger" id="special_delivery_or_appointment_charge_min_error"></span>
                                        		</div>
                                        		<div class="col-md-7 mb-4">
                                        			<label>Spe Del / App. Surcharge</label>
                                        			<div class="input-group">
                                        				<input type="text" class="form-control numeric-decimal" placeholder="Special Delivery / Appointment Charge" id="special_delivery_charge" name="applied_special_delivery_or_appointment_charge">
                                        				<select class="form-control" id="special_delivery_charge_type" name="applied_special_delivery_or_appointment_charge_type">
                                        					<option>Fixed</option>
                                        					<option>Percentage</option>
                                        				</select>
                                        			</div>
                                        			<span class="text-danger" id="special_delivery_or_appointment_charge_error"></span>
                                        		</div>
                                        	</div>
                                    	</div>
                                	</div>
                        ...
                        <div id="part-2">
                            <h6 class="mb-4"><a href="javascript:void(0)" type="button" class="btn btn-primary btn-sm" id="step2"><i class="fa fa-reply"></i>&nbsp; Back To Pickup Details</a></h6> 
                            <div class="card mb-3">
                            ...
                            <div class="card mb-3">
                                <div class="card-header">
                                    <strong class="card-title">Consigner Details</strong>	              
                                </div>
                                <div class="card-body row">
                                    ...
                                    <div class="col-lg-4">     
                                        <div class="form-group">
                                            ...
                                            <input name="consigner_company" id="consigner_company" type="text" placeholder="Enter Company Name " class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-lg-4">     
                                        <div class="form-group">
                                            <label class="control-label mb-1">Consigner Name<span class="text-danger">*</span></label>
                                            <input name="consigner_name" id="consigner_name" type="text" placeholder="Enter Consigner Name" class="form-control">
                                            <span id="consigner_nameerror" class="text-danger"></span> 
                                        </div>
                                    </div>
                                     ...
                                     <div class="col-lg-4">     
                                        <div class="form-group">
                                            ...
                                            <input name="consigner_phone" id="consigner_phone" type="text" placeholder="Enter Phone Number" class="form-control" >
                                            <span id="consigner_phoneerror" class="text-danger"></span> 
                                        </div>
                                    </div>
                                    <div class="col-lg-6">     
                                        <div class="form-group">
                                            <label class="control-label mb-1">Email Address</label>
                                            <input name="consigner_email" id="consigner_email" type="text" placeholder="Enter Email" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">     
                                        <div class="form-group">
                                            <label class="control-label mb-1">Address<span class="text-danger">*</span></label>
                                            <input name="consigner_address" id="consigner_address" type="text" placeholder="Enter Address" class="form-control">
                                            <span id="consigner_addresserror" class="text-danger"></span> 
                                        </div>
                                    </div>
                                    <div class="col-lg-6">     
                                        <div class="form-group">
                                            <label class="control-label mb-1">City<span class="text-danger">*</span></label>
                                            <input name="consigner_city" id="consigner_city" type="text" value="" placeholder="Enter City" class="form-control" >
                                            <span id="consigner_cityerror" class="text-danger"></span> 
                                        </div>
                                    </div>
                                    <div class="col-lg-6">     
                                        <div class="form-group">
                                            <label class="control-label mb-1">State<span class="text-danger">*</span></label>
                                            <input name="consigner_state" id="consigner_state" type="text" value="" placeholder="Enter State" class="form-control" >
                                            <span id="consigner_stateerror" class="text-danger"></span> 
                                        </div>
                                    </div> 
                            ...
                            <div class="card">
                                ...
                                <div class="card-body row">
                                    ...
                                    <input type="hidden" name="cartage_charge_6cft"  id="cartage_charge_6cft" >
                                    ...
                                    <input type="hidden" name="cartage_charge_8cft"  id="cartage_charge_8cft" >
                                    ...
                                    <input type="hidden" name="cartage_charge_10cft"  id="cartage_charge_10cft" >
                            ...
                            <!--Manual Rate Add-->
                            <input type="hidden" id="branch_charge" value="<?= $get_user_details[0]['branch_charge']; ?>">
                            
                            <div class="row">
                                <?php
                                    if($get_user_details[0]['branch_charge']=='no')
                                    {
                                ?>
                                        <div class="col-lg-6 mt-2 d-flex">
                                            <div class="form-group ">
                                                <label><b id="manual_rate_label"></b> <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control numeric-decimal" name="weight_rate" id="manual_rate" placeholder="Enter Rate">
                                                <span class="text-danger" id="manual_rate_error"></span>
                                            </div>
                                        </div>
                                <?php
                                    }
                        ...
                        <div id="part-3">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                                        ...
                                                        <span class="custom-option-body">
                                                            <div class="row logis">
                                                                ...
                                                                <div class="col-lg-2 col-sm-9 p-0"> 
                                                                    ...
                                                                    <p id="vol_weight<?= $cf; ?>" class="mt-4"></p> 
                                                                </div>
                                                                ...
                                                                <div class="col-lg-2 col-sm-9 p-0 text-center">
                                                                    <div class="grey mt-5">
                                                                        <h3 style="font-size:20px;"><b><i class="fa fa-inr"></i><span id="tfr_cost<?= $cf; ?>"></span></b></h3>
                                    ...
                                    {
                                        $cond =array("branches`.`id"=>$user_id);
                                        $join= array('0'=>array('LEFT','3pls','3pls','id','branches','threepl'));
                                        $get_3pl = $query->getData("*","branches",$join,$cond,"","","")[0];
                                        ?>
                                        <div class="row mt-3">
                                            <div class="col-md-12  mb-2">
                                                <div class="form-check custom-option custom-option-basic">
                                                  <label class="form-check-label custom-option-content" for="cft_type1">
                                                    ...
                                                    <span class="custom-option-body">
                                                        <div class="row logis">
                                                            ...
                                                            <div class="col-lg-2 col-sm-9 p-0 text-center">
                                                                <div class="grey mt-5">
                                                                    <h3 style="font-size:20px;"><b><i class="fa fa-inr"></i><span id="tfr_cost"></span></b></h3>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4 text-center p-0 mt-1">
                                                                <p class="small"> <i class="fa fa-map-marker"></i> Tracking : Real Time </p>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <button type="button" name="savePickupOrder" class="btn btn-primary mt-2">Save Pickup Order</button> 
                                            </div>                   
                                        </div>
                                        <div class="col-lg-6">     
                                            <div class="form-group text-end">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="modalToggleLabel">Save Pickup Order</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <!--<div class="form-group mb-2">-->
                                                    <!--    <label class="control-label mb-1">Upload Id</label>-->
                                                    <!--    <input name="uploadId" id="uploadId" type="text" value="" placeholder="Enter Upload Id" class="form-control">-->
                                                    <!--    <span id="uploadiderror" class="text-danger"></span>-->
                                                    <!--</div>-->
                                                    <div class="row">
                                                        <div class="col-md-6 form-group">
                                                            <label class="control-label mb-1">Master Waybill No<span class="text-danger">*</span></label>
                                                            <input name="master_waybill_no" id="masterAWB" type="text" value="" placeholder="Enter Master AWB" class="form-control">
                                                            <span id="masterWaybillerror" class="text-danger"></span>
                                                        </div>
                                                        <div class="col-md-6 form-group">
                                                            <label class="control-label mb-1">Client Ref No.<span class="text-danger">*</span></label>
                                                            <input name="client_ref_no" id="client_ref_no" type="text" value="" placeholder="Enter Client Reference No." class="form-control">
                                                            <span id="clientReferror" class="text-danger"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="modal-footer">
                                                    <button class="btn btn-primary" type="button" name="savePickupOrdersUploadId" >Save Order</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
?>
    ...
    <script>
        ...
        function validateStep2() {
            ...
            // consigner
            var consignerFields = [
                { selector: "#consigner_name", errorMessage: "Please enter Consigner Name." },
                { selector: "#consigner_phone", errorMessage: "Please enter Phone Number." },
                { selector: "#consigner_address", errorMessage: "Please enter Address." },
                { selector: "#consigner_city", errorMessage: "Please enter City." },
                { selector: "#consigner_state", errorMessage: "Please enter State." }
            ];
    
            consignerFields.forEach(function(field) {
                var value = $(field.selector).val().trim();
                var errorSpan = $(field.selector).siblings(".text-danger");
                if (value === "") {
                    errorSpan.text(field.errorMessage);
            ...
            var branch_charge = $("#branch_charge").val();
            if(branch_charge=='no')
            {
                var Manualratefields = [
                    { selector: "#manual_rate", errorMessage: "Please enter Manual Rates." }
                ];
        
                Manualratefields.forEach(function(field) {
                    var value = $(field.selector).val().trim();
                    var errorSpan = $(field.selector).siblings(".text-danger");
                    if (value === "") {
                        errorSpan.text(field.errorMessage);
    ...
    <script>
        function calculateTotalCharge(weightCharge) {
            ...
            var cartageCharge = parseFloat($("#cartage_charge").val());
            var branchType = $("#branch_type").val();
            if(branchType == 'agent')
            {
                var cartageChargeType = $("#cartage_charge_type").val();
            }
            ...
            if (branchType !== 'agent') {
                if (cartageChargeType === 'Kg') {
                    cartageCharge *= volweightCFT;
                } else if (cartageChargeType === 'Quantity') {
                    cartageCharge *= totalQty;
                }
            }
            
    
            // Calculate total fixed charges
            var totalFixedCharges = Number(codCharge) + Number(fuelSurcharge) + Number(awbCharge) + Number(fobSurcharge) + Number(handlingCharge) + Number(pickupCharge)  + Number(odaSurcharge) + Number(packagingSurcharge) + Number(cartageCharge);
            ...
            var Otherscharge =  Number(fobSurcharge) + Number(handlingCharge) + Number(pickupCharge) + Number(packagingSurcharge)  +Number(cartageCharge);
            ...
            $("#cartage_charge" + idPrefix).val(cartageCharge);
    ...
    <script>
        ...
        function calculateTotalChargeForCubicFeet(weightCharge, idPrefix) {
            ...
            for (var c = 1; c <= 3; c++) {
                ...
                $("#others_charges" + a).text((fobSurcharge + handlingCharge + pickupCharge + packagingSurcharge + cartageCharge).toFixed(2));
                $("#tfr_cost" + a).text(total_charge_withGst.toFixed(2));
                $("#weight_charge" + a).text(total_weight_charge);
                $("#vol_weight" + a).text('Vol. Weight: ' + volweight + ' Kg');
            }
        }
    </script>
        ...
        $(document).ready(function(){
            ...
            $("#step1").click(function(){
                ...
                if (branchType === 'branch') {
                    ...
                    if ($("#cod_charge_min").val().trim() === "") {
                        $("#cod_charge_min_error").text("COD Min is required.");
                        errors++;
                    } else {
                        $("#cod_charge_min_error").text("");
                    }
        
                    if ($("#cod_charge").val().trim() === "") {
                        $("#cod_charge_error").text("COD Charge is required.");
                        errors++;
                    } else {
                        $("#cod_charge_error").text("");
                    }
        
                    if ($("#fuel_surcharge").val().trim() === "") {
                        $("#fuel_surcharge_error").text("This field is required.");
                        errors++;
                    } else {
                        $("#fuel_surcharge_error").text("");
                    }
        
                    if ($("#awb_charge").val().trim() === "") {
                        $("#awb_charge_error").text("This field is required.");
                        errors++;
                    } else {
                        $("#awb_charge_error").text("");
                    }
        
                    if ($("#fob_surcharge_minimum").val().trim() === "") {
                        $("#fob_surcharge_minimum_error").text("FOV Min is required.");
                        errors++;
                    } else {
                        $("#fob_surcharge_minimum_error").text("");
                    }
        
                    if ($("#fob_surcharge_percentage").val().trim() === "") {
                        $("#fob_surcharge_percentage_error").text("FOV Per is required.");
                        errors++;
                    } else {
                        $("#fob_surcharge_percentage_error").text("");
                    }
        
                    if ($("#handeling_charge").val().trim() === "") {
                        $("#handeling_charge_error").text("This field is required.");
                        errors++;
                    } else {
                        $("#handeling_charge_error").text("");
                    }
        
                    if ($("#pickup_charge").val().trim() === "") {
                        $("#pickup_charge_error").text("This field is required.");
                        errors++;
                    } else {
                        $("#pickup_charge_error").text("");
                    }
        
                    if ($("#damage_surcharge_min").val().trim() === "") {
                        $("#damage_surcharge_min_error").text("This field is required.");
                        errors++;
                    } else {
                        $("#damage_surcharge_min_error").text("");
                    }
        
                    if ($("#damage_surcharge").val().trim() === "") {
                        $("#damage_surcharge_error").text("This field is required.");
                        errors++;
                    } else {
                        $("#damage_surcharge_error").text("");
                    }
        
                    if ($("#oda_surcharge_min").val().trim() === "") {
                        $("#oda_surcharge_min_error").text("This field is required.");
                        errors++;
                    } else {
                        $("#oda_surcharge_min_error").text("");
                    }
        
                    if ($("#oda_surcharge").val().trim() === "") {
                        $("#oda_surcharge_error").text("This field is required.");
                        errors++;
                    } else {
                        $("#oda_surcharge_error").text("");
                    }
        
                    if ($("#packaging_surcharge").val().trim() === "") {
                        $("#packaging_surcharge_error").text("This field is required.");
                        errors++;
                    } else {
                        $("#packaging_surcharge_error").text("");
                    }
        
                    if ($("#cartage_charge").val().trim() === "") {
                        $("#cartage_charge_error").text("This field is required.");
                        errors++;
                    } else {
                        $("#cartage_charge_error").text("");
                    }
        
                    if ($("#special_delivery_or_appointment_charge_min").val().trim() === "") {
                        $("#special_delivery_or_appointment_charge_min_error").text("This field is required.");
                        errors++;
                    } else {
                        $("#special_delivery_or_appointment_charge_min_error").text("");
                    }
        
                    if ($("#special_delivery_charge").val().trim() === "") {
                        $("#special_delivery_or_appointment_charge_error").text("This field is required.");
                        errors++;
                    } else {
                        $("#special_delivery_or_appointment_charge_error").text("");
                    }
                ...
                if(branch_charge=='no')
                {
                    var pickup_pincode = $("#pin").val();
                    var delivery_pincode = $("#del_pin").val();
                    $.ajax({
                        url: "rate_calculation.php",
                        type: "POST",
                        data: {
                ...
                if (isValid) {
                    ...
                    if(freight_type == 'Weight')
                    {
                        if(threepl=='all')
                        {
                            if(branch_charge=='no')
                            {
                                var manual_rate = parseFloat($("#manual_rate").val());
                                var freight_cost_sixcft_volweight = parseFloat(sixcft_volweight*manual_rate).toFixed(2);
                                var freight_cost_eightcft_volweight = parseFloat(eightcft_volweight*manual_rate).toFixed(2);
                                var freight_cost_tencft_volweight = parseFloat(tencft_volweight*manual_rate).toFixed(2);
                                $("#part-1").hide();
                                $("#part-2").hide();
                                $("#part-3").show();
                        ...
                        else if (threepl=='1')
                        {
                            if(branch_charge=='no')
                            {
                                ...
                                $("#part-2").hide();
                                $("#part-3").show();
                                calculateTotalCharge(freight_cost_sixcft_volweight);
                            }
                            else
                            {
                                $.ajax({
                        ...
                        else if (threepl=='2')
                        {
                            if(branch_charge=='no')
                            {
                                ...
                                $("#part-2").hide();
                                $("#part-3").show();
                                calculateTotalCharge(freight_cost_eightcft_volweight);
                            }
                            else
                            {
                                $.ajax({
                        ...
                        else if (threepl=='3')
                        {
                            if(branch_charge=='no')
                            {
                                ...
                                $("#part-2").hide();
                                $("#part-3").show();
                                calculateTotalCharge(freight_cost_tencft_volweight);
                            }
                            else
                            {
                                $.ajax({
                    ...
                    else
                    {
                        ...
                        {
                            var manual_rate = parseFloat($("#manual_rate").val());
                            var freight_cost_QTY = parseFloat(totalQty*manual_rate).toFixed(2);
                            $("#part-1").hide();
                            $("#part-2").hide();
                            $("#part-3").show();
                            calculateTotalCharge(freight_cost_QTY);
                        }
                        else
                        {
                            $.ajax({
    ...
    <script>
        $("button[name=add_newOrder]").click(function(e){
            if(!$("input[name='cft_type']").is(":checked")){
                warningToast("Please select a shipment charge type.");
                return false;
            }else{
                blurBody();
                $('body').before(loader('fixed'));
                $('button[name=add_newOrder]').parent('div').append(`<input type="hidden" name="add_Order">`);
        ...
        $("button[name=savePickupOrdersUploadId]").click(function(e){
            let submitValidation = true;
            if(!$("input[name='cft_type']").is(":checked")){
                warningToast("Please select a shipment charge type.");
                submitValidation = false;
            }
            if($("input[name=master_waybill_no]").val() == ""){
                $("#masterWaybillerror").text('Invalid Master AWB No.');
                submitValidation = false;
            }
            if($("input[name=client_ref_no]").val() == ""){
                $("#clientReferror").text('Invalid Client Ref No.');
                submitValidation = false;
            }
            if(submitValidation == true){
                blurBody();
                $('body').before(loader('fixed'));
                $('button[name=add_newOrder]').parent('div').append(`<input type="hidden" name="saveForPickup">`);
                $('button[name=savePickupOrder]').html(`<span class="spinner-border spinner-border-sm text-white" style="margin: 4px 20px;"></span>`);
                $('button[name=savePickupOrder]').attr('disabled', true);
                $(this).html(`<span class="spinner-border spinner-border-sm text-white" style="margin: 4px 20px;"></span>`);
                $(this).attr('disabled', true);
                $("form").submit();
            }
        });
        $("button[name=savePickupOrder]").click(function(e){
            e.preventDefault();
            if(!$("input[name='cft_type']").is(":checked")){
                warningToast("Please select a shipment charge type.");
            }else{
                $('button[name="pickupOrder"]').remove();
                $("button[name=savePickupOrder]").parent("div").append('<button type="button" name="pickupOrder" data-bs-toggle="modal" data-bs-target="#modalToggle" class="d-none"></button>');
                $('button[name="pickupOrder"]').click();
            }
        });
    </script>
    <script>
