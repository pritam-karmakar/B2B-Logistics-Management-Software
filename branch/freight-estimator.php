...
<?php if($get_user_details[0]['type'] == "agent" && $get_user_details[0]['branch_charge'] == "yes"){ ?>
    <!-- Content -->
...
<?php
    ...
    if($get_user_details[0]['branch_type'] == "agent"){
?>
    <script src="menu/freight.js"></script>
<?php
    }else{
        echo '<script type="text/javascript" language="javascript">dangerToast("You don\'t have access to the freight calculator!");</script>';
    }
?>