                            ...
                            <div class="nav-align-top mb-4">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade active show" id="navs-top-home" role="tabpanel">
                                        <form action="https://kingfishlogistics.in/b2b/branch/addmoney" method="POST">
                                            <div class="row mb-3">
                                              <label class="col-sm-2 col-form-label" for="basic-default-name">Name</label>
                                              <input type="hidden" class="form-control" name="type_id"  value="<?php echo $user_id; ?>" />
                                              <div class="col-sm-10">
                                                <input type="text" class="form-control name" name="name" id="basic-default-name" value="<?= $get_user_details[0]['branch_name']; ?>" readonly/>
                                              </div>
                                            </div>
                                            ...
                                            <div class="row justify-content-end">
                                              <div class="col-sm-12">
                                                <button type="submit" class="btn btn-danger" name="add_money_gateway" style="float:right;">Add Money</button>
                                              </div>
                                            </div>
                                        </form>
                                    </div>
